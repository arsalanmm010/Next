...
export default function Hero() {
  return (
    <Box pt='140px'>
        <VStack>
           <Heading fontFamily='Raleway' fontWeight='400' fontSize='48px'>We Are <Text as='span' color='blue'>Proud</Text></Heading>
           <Text fontSize='15px' fontFamily='Nunito' mb='20px' color='gray'>You don't have to struggle alone, you've got our assistance and help.</Text>
           <Flex w='100%' justify='space-between' px='40px'>
              <Card w='24%' h='240px' bg='blue.600' color='white' alignItems='center' justifyContent='center'>
                    <Image src='/img1.png' alt='img'/>
                    <Text fontSize='34px'>5,000</Text>
                    <Text fontSize='15px'>Students Enrolled</Text>
              </Card>
              <Card w='24%' h='240px' bg='red.500' color='white' alignItems='center' justifyContent='center'>
              ...
              <Card w='24%' h='240px' bg='purple.500' color='white' alignItems='center' justifyContent='center'>
              ...
              <Card w='24%' h='240px' bg='green.500' color='white' alignItems='center' justifyContent='center'>
     ...
     <HStack mx='30px' justify='space-between'>
         <Box w='50%' h='550px'>
              <Image src='/IMAGE (3).png' alt='imgg'  pl='100px'/>
           </Box>
        ...
        <VStack alignContent='center' justifyContent='center' mb='90px'>
           <Heading fontSize='48px' fontWeight='normal'>The Program in a Nutshell</Heading>
           <Heading fontSize='30px' fontWeight='normal' color='red'>Earn While You Learn</Heading>
           <Text textAlign='center' w='50%' fontSize='18px' color='gray' >In this brand-new type of curriculum, students will learn how to make money and boost exports in the classroom and will begin doing so within six months of the program's beginning. It resembles a cross between a corporate venture and an educational project.</Text>
        </VStack>
        <HStack mx='30px' justify='space-between'>
           <VStack w='50%' align='flex-start'>
        ...
        </HStack><HStack mx='30px' my='50px' justify='space-between'>
        <Box w='50%' h='350px'>
           <Image src='/IMAGE (2).png' alt='img' pl='100px' pt='60px'/>
</Box>
           <VStack w='50%' align='flex-start' spacing='51px'>
